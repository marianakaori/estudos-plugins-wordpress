        ...
        ?>
            ...
            <p>
                ...
                <input
                    class="widefat"
                    type="text"
                    id="<?= $this->get_field_id('urlFacebook'); ?>"
                    name="<?= $this->get_field_name('urlFacebook'); ?>"
                    value="<?= $urlFacebook ?>"
                >
            </p>
            <p>
                ...
                <input
                    class="widefat"
                    type="text"
                    id="<?= $this->get_field_id('urlTwitter'); ?>"
                    name="<?= $this->get_field_name('urlTwitter'); ?>"
                    value="<?= $urlTwitter ?>"
                >
            </p>
            <p>
                ...
                <input
                    class="widefat"
                    type="text"
                    id="<?= $this->get_field_id('urlInstagram'); ?>"
                    name="<?= $this->get_field_name('urlInstagram'); ?>"
                    value="<?= $urlInstagram ?>"
                >
            </p>
            <p>
                ...
                <input
                    class="widefat"
                    type="text"
                    id="<?= $this->get_field_id('urlYoutube'); ?>"
                    name="<?= $this->get_field_name('urlYoutube'); ?>"
                    value="<?= $urlYoutube ?>"
                >
            </p>
        <?php
